...
class LocalUrlGenerator extends BaseUrlGenerator
{
    ...
    /**
     * {@inheritdoc}
     * @throws \Udhuong\LaravelUploadFile\Exceptions\MediaUrlException If media's disk is not publicly accessible
     */
    public function getUrl(): string
    {
        /** @var Cloud $filesystem */
        $filesystem = $this->filesystem->disk($this->media->disk);
        return $filesystem->url($this->getDiskPath());
    }
    ...
    {
        return $this->getDiskConfig('root') . DIRECTORY_SEPARATOR . $this->getDiskPath();
    }
